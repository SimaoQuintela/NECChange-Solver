      ...
      <main className='flex h-screen justify-center items-center text-white bg-[#4A71E0] sm:bg-[#3658b7]'>
        <div className='w-auto h-auto rounded-2xl bg-[#4A71E0] lg:min-w-[35%] sm:shadow-2xl'>
          <div className='flex justify-center items-center p-10'>
            <Image src='/logos/necc(2).svg' width={50} height={50} />
          </div>
          <div className='text-4xl text-center font-bold'>Welcome Back</div>
          <div className='py-4 text-center font-bold'> Login to your account</div>
          <div className=''>
            <form className='p-10 rounded-xl space-y-[2%]'>
              <div className='flex flex-col space-y-[2%]'>
                <div className="relative mb-1">
                  ...
                  <input className='block w-full pl-10 py-2 rounded-full border bg-transparent placeholder-slate-300' type='email' name='email' id='email' placeholder="name@alunos.uminho.pt"/>
                </div>
                <div className="relative mb-6">
                  ...
                  <input className='block w-full pl-10 py-2 rounded-full border bg-transparent placeholder-slate-300' type='password' name='password' id='password' placeholder="Password"/>
                </div>
              </div>
              <div className='flex justify-between items-center'>
                <div className='form-group form-check'>
                  <input type='checkbox' className='' id='checkbox' />
                  <label className='p-2 text-sm' for='checkbox'>Remember me </label>
                </div>
                <a href='#' className='underline text-sm'>Forgot Password?</a>
              </div>
              <div className='flex pt-[5%] text-lg'>
                <button type='submit' className='block ml-auto mr-auto w-full py-2 rounded-full border border-[#1D4ED8] bg-[#1D4ED8] '>LOGIN</button>
              </div>
              <div className='flex justify-center text-sm'>
                <a href='#' className=''>Don't have an account? <a href='#' className='underline'> Sign Up</a></a>
              </div>
            </form>
          </div>
